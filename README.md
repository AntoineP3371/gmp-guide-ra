...
| `backend/` | API, stockage média, assemblage et versionnement des *manifests* | PocketBase (binaire Go + SQLite) + hooks JS | **Raspberry Pi 4** au domicile de l'auteur, exposé via **Cloudflare Tunnel** (`api_guidera.gmpbordeaux.fr`) |
